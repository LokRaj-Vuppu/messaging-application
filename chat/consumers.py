...
class ChatroomConsumer(WebsocketConsumer):
    def connect(self):
        ...
        self.chatroom_name = self.scope['url_route']['kwargs']['chatroom_name'] #fetching group-name by url params
        self.chatroom = get_object_or_404(ChatGroup, group_name=self.chatroom_name)
        
        # adding channel layer and adding a group for group chat, for all users to have a same websocket / group for all user, helps to send the messages to all the ative users in the group
    ...
    def disconnect(self, close_code):
        ...
        # remove and udpdate the online users
